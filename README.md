...
## Tech/framework used
      ...
      --> Docker Image to bundle the Jar. (Will be added soon - with build inside docker image)
      
      --> Docker Image to host the Jar. (Will be added soon - with pre built jar inside docker image)
	  
      --> Docker or Kubernetes to run the docker image. (Will be added soon - With build inside docker image, built either by option 1 or 2 above)
